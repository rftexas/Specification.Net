...
public static class EntityFrameworkCoreExtension
{
    ...
    public static TEntity Single<TEntity>(this IQueryable<TEntity> queryable, Specification<TEntity> spec) =>
        queryable.Single(spec.Expression);

    public static Task<TEntity> SingleAsync<TEntity>(this IQueryable<TEntity> queryable, Specification<TEntity> spec) =>
        queryable.SingleAsync(spec.Expression);
    public static TEntity? SingleOrDefault<TEntity>(this IQueryable<TEntity> queryable, Specification<TEntity> spec) =>
